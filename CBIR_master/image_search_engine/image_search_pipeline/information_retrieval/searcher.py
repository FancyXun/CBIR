...
class Searcher:
    ...
    def search(self, queryHist, numResults=10,
               maxCandidates=200):  # maxCandidates: the maximum number of image indexes to grab from the inverted index that shares a significant number of visual words with the query
        ...
        candidateIdxs = self.buildCandidates(queryHist,
                                             maxCandidates)  # the list of image indexes that shares a significant number of visual words in the query.
        candidateIdxs.sort()
