...
from sklearn.metrics import \
    pairwise  # efficiently compute the Euclidean Distance between feature vectors in our database and our vocabulary
...
vis = {i: [] for i in np.arange(0,
                                len(vocab))}  # dictionary will be the integer index of the word, and the value will be a list tuples (i.e., the image ID and keypoint location) of the image patches most representative of the word
